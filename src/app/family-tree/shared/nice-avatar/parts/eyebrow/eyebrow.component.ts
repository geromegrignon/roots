...
import type { EyeBrowStyle } from '../../nice-avatar-config';

@Component({
  selector: 'app-nice-avatar-eyebrow',
...
export class NiceAvatarEyebrowComponent {
  variant = input.required<EyeBrowStyle>();
}
