...
import type { GlassesStyle } from '../../nice-avatar-config';

@Component({
  selector: 'app-nice-avatar-glasses',
...
export class NiceAvatarGlassesComponent {
  variant = input.required<GlassesStyle>();
}
